...
<body>
    ...
    <div class="app-container">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            <h5 class="fw-bold mb-0 text-white">Rapor Kehadiran Gedung</h5>
        ...
        <div class="card card-custom text-center py-5">
            <i class="bi bi-rocket-takeoff-fill text-indigo mb-3" style="font-size: 3.5rem; color: #818cf8;"></i>
            <h5 class="fw-bold text-white mb-2">Fitur Segera Hadir!</h5>
            <p class="text-slate-400 small px-3 mb-4" style="color: #94a3b8; font-size: 0.82rem;">Modul rekapitulasi rapor kehadiran & performa penghuni gedung sedang disiapkan oleh tim pengembang.</p>
            <a href="{{ route('pj.dashboard') }}" class="btn text-white rounded-pill px-4 py-2 fw-semibold shadow-sm mx-auto" style="background: var(--primary-gradient); border: none; width: fit-content;">
                Kembali ke Beranda
            </a>
        </div>
